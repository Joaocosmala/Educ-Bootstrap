...
Veja um exemplo:
/p class="/h1"> Bootstrap</

/p class="/h2"> Bootstrap</

/p class="/h3"> Bootstrap</

/p class="/h4"> Bootstrap</

/p class="/h5"> Bootstrap</

/p class="/h6"> Bootstrap</
...
/class="/display1">/display-1, Bootstrap</
/class="/display2">/display-2, Bootstrap</
/class="/display3">/display-3, Bootstrap</
/class="/display4">/display-4, Bootstrap</
